...
```
    ...
    ## <environment: 0x000002aae18c99a0>
...
```
    ...
    ## 
    ##   cp           RMSE       Rsquared    
    ##   0.007759842   77.55145  0.7890722715
    ##   0.008713219   77.51513  0.7892589301
...
| :---------------- | ---------: | --------: |
| Non-Ensemble Tree |   77.51513 |  79.35698 |
| Boosted Tree      |   46.60444 |  46.74742 |
| MLR               |  112.94927 | 115.77574 |
...
```
    ...
    ## There were 16 predictors of which 13 had non-zero influence.
